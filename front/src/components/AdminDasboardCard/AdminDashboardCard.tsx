	...
	return (
		<div>
			<div className="bg-white shadow-md ">
				<div className="flex font-bold  justify-between bg-altBgColor p-4">
					...
					<div className="w-24 text-start">N de lotes</div>
					<div className="w-24 text-end">Activo</div>
					<div className="w-24 text-end">Editar</div>
					<div className="w-24 text-end">Borrar</div>
				</div>
				{newArrayUsers &&
					newArrayUsers.map((user) => (
						...
						>
							...
							<div className="w-24 text-end mr-4 ">
