...
const PlotPanel: React.FC<PlotPanelProps> = ({ plots, setPlots }) => {
  ...
  return (
    <div className="w-full max-w-screen-lg min-h-screen mx-auto p-4 flex flex-col">
      <div className="mb-8">
        <h1 className="text-2xl text-gray-900 font-bold text-start uppercase">
          Todos tus lotes
          <span className="poppins-extralight"> En un solo lugar.</span>
        </h1>
        <h2 className="text-lg text-gray-800 poppins-regular mt-10">
