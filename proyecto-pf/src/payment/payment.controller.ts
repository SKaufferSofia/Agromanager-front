...
const PORT_FRONT = process.env.FRONT_port;
const client = new MercadoPagoConfig({
  accessToken:
    'APP_USR-2153251236509260-072420-60f2e63794bbe036a72101e58fa5cf86-1917367384',
});
...
export class PaymentController {
  ...
  async suscripcionMensual(@Param('id', ParseUUIDPipe) id: UUID) {
    if (
      (await this.userRepository.getUserById(id)).roles.some(
